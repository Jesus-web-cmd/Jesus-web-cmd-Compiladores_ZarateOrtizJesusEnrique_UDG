...
{
  "$end", "error", "$undefined", "ID", "INT", "IGUAL", "PUNTOYCOMA",
  "$accept", "programa", "declaraciones", "asignaciones", YY_NULL
};
#endif
...
/* Line 1792 of yacc.c  */
#line 48 "parser.y"
    { agregar_tipo((yyvsp[(2) - (3)].str), 0); }
    break;

  case 4:
/* Line 1792 of yacc.c  */
#line 49 "parser.y"
    { agregar_tipo((yyvsp[(3) - (4)].str), 0); }
    break;
...
#line 53 "parser.y"
    {
        if (!existe((yyvsp[(1) - (4)].str)) || !existe((yyvsp[(3) - (4)].str)))
            printf("Error: identificador no declarado\n");
        else if (buscar_tipo((yyvsp[(1) - (4)].str)) != buscar_tipo((yyvsp[(3) - (4)].str)))
...
#line 59 "parser.y"
    {
        if (!existe((yyvsp[(2) - (5)].str)) || !existe((yyvsp[(4) - (5)].str)))
            printf("Error: identificador no declarado\n");
        else if (buscar_tipo((yyvsp[(2) - (5)].str)) != buscar_tipo((yyvsp[(4) - (5)].str)))
            printf("Error: tipos incompatibles\n");
    }
    break;
