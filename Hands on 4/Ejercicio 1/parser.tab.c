...
{
  "$end", "error", "$undefined", "ID", "INT", "PUNTOYCOMA", "$accept",
  "programa", "declaraciones", "usos", YY_NULL
};
#endif
...
/* Line 1792 of yacc.c  */
#line 40 "parser.y"
    { agregar((yyvsp[(2) - (3)].str)); }
    break;

  case 4:
/* Line 1792 of yacc.c  */
#line 41 "parser.y"
    { agregar((yyvsp[(3) - (4)].str)); }
    break;
