...
{
       0,     0,     3,     5,     6,    11,    13,    16,    20,    23
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
       9,     0,    -1,    10,    -1,    -1,     5,    11,    12,     6,
      -1,    13,    -1,    12,    13,    -1,     4,     3,     7,    -1,
       3,     7,    -1,    10,    -1
};
...
{
  "$end", "error", "$undefined", "ID", "INT", "LLAVEIZQ", "LLAVEDER",
  "PUNTOYCOMA", "$accept", "programa", "bloque", "$@1", "instrucciones",
  "instruccion", YY_NULL
};
#endif
